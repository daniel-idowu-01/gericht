        ...
        <div className='h-screen overflow-y-hidden bg-black'>
            <div className="grid place-items-center md:mx-40 pb-72 h-full p-10 md:p-20">
                ...
                <form>
                    ...
                    <input className='bg-transparent border p-2 px-5 outline-none w-full md:w-96 text-white' type="password" placeholder='Password' /> <br /><br />
                    ...
                    <button onClick={deadLInk} className='bg-goldcolor text-black p-2 px-5 hover:opacity-75 hover:text-white' type="submit">Login</button>
                     <hr className='opacity-30 mt-5'/>
                    <p className='text-center text-white opacity-80 mt-5'>Don't have an account yet? <Link to='/register' className='text-goldcolor'>Register</Link> Here</p>
                </form>
            </div>
        </div>
    )
